...
<#macro "date-time">
    ...
    <#if .node["@type"]! != "time">
        ...
        <script>$('#${id}').datetimepicker({toolbarPlacement:'top', showClose:true, showClear:true, showTodayButton:true, defaultDate: '${fieldValue?html}' && moment('${fieldValue?html}','${datepickerFormat}'), format:'${datepickerFormat}', stepping:1, locale:"${ec.getUser().locale.toLanguageTag()}"});</script>
    <#else>
